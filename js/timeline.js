...
function renderLockedCard(event, selectedTierId) {
  ...
  return el("article", { class: "timelineCard timelineLocked", id: safeText(event.id) }, [
...
async function loadTimeline() {
  ...
  function scrollToHash() {
    ...
    target.classList.add("timelineFlash");
    window.setTimeout(() => target.classList.remove("timelineFlash"), 1400);
  }
