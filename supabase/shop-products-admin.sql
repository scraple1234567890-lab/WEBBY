...
-- allow the auth trigger (and manual inserts) to create a row for the user
...
-- prevent self-escalation in the client
...
values
  ...
  (
    ...
    7,
    'Field kit',
    './assets/images/Image_202512081305.jpeg',
    'Guides you back to campus pathways and safe circles.',
    array['Glow-in-dusk dial','Anchor rune','Adjustable chain']
  ),
  (
    'ember-cloak',
    'Emberlined Cloak',
    ...
    'Limited',
    './assets/images/hero-approach.png',
    'Lightweight warmth with flame-resistant lining.',
    array['Heat-buffer weave','Hidden pockets','Storm fastenings']
  ),
  (
    'inkstone',
    'Runic Inkstone',
    ...
    'New',
    './assets/images/Image_202512081359.jpeg',
    'A stone slab that keeps glyph ink fresh for days.',
    array['Self-sealing basin','Travel sleeve','Ink calibrator']
  ),
  (
    'scent-pins',
    'Scentweaver Pins',
    ...
    'Giftable',
    './assets/images/These_are_the_202512031938.jpeg',
    'Pins infused with subtle aromatics for calm focus.',
    array['Cedar + citrus','Safe-lock clasp','Refillable']
  ),
  (
    'portal-notebook',
    'Pocket Portal Notebook',
    'Field notes',
    'Fieldwork',
    62,
    4.8,
    ...
    'Traveler',
    './assets/images/Image_202512081305.jpeg',
    'Sketch maps, sigils, and doorways without smudging.',
    array['Ink-proof paper','Bookmark ribbon','Fold-out map grid']
  )
